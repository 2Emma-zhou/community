...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Label</td>
      <td>Displays labels and the models under each label</td>
    </tr>
    <tr>
      <td rowspan="4">2</td>
    ...
    <tr>
      ...
      <td>Create data models by manually inputting JSON.</td>
    </tr>
    <tr>
      <td>3</td>
      <td>Raw Topics</td>
...
<td>Add extended information for the folder. Eg. unit.</td>
</tr>
<tr>
...
4. Expand **Raw Topics**, find the topic you defined.
5. Click **Topic to File** icon next to the topic, and then edit the file and complete the namespace creation.
