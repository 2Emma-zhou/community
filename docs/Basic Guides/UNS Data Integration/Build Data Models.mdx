...
<tr>
<td><strong>Auto-Parsed</strong></td>
...
3. Select **equipment**, and then click <img src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/75.png" /> > **New Topic** to add a topic (e.g.`CNC`) under it.
