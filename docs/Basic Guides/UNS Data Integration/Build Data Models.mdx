...
:::info
You can connect databases under **Dev Tools** > **Data Source Management**. For details, see <a href="../Database Management/Database Connection.mdx">Database Connection</a>.
:::
