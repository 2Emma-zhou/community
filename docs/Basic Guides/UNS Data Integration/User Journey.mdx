...
- Tier0 builds data models in a hierarchical structure (folder-file), making it easy to track and understand;
...
:::note
- **Source Flow** and **Event Flow** are based on **Node-RED**. For detailed instructions, please see <a href="https://nodered.org/docs/tutorials/first-flow">NodeRed</a>.
