supOS supports service routing based on Konga. Following certain rules, you can:
...
<table>
        ...
        <tbody>
            <tr>
                <td>menu</td>
                <td>The service will appear as an application on supOS homepage.</td>
            </tr>
            <tr>
                <td>parentName:menu.tag.xxx</td>
                <td>xxx is the name of an existing first-level menu in supOS (all in lowercase). It indicates that the current route appears as a second-level menu of xxx.</td>
            </tr>
            <tr>
                <td>homeParentName:menu.tag.xxx</td>
                <td>xxx is the name of an existing first-level menu in supOS (all in lowercase). It indicates that the current route appears in the navigation bar and serves as a second-level menu of xxx.</td>
            </tr>
            <tr>
