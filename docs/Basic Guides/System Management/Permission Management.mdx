...
2. Click **Role Permission** at the upper-right corner, and then click **Add**.
3. Enter the role name, and then select permissions for the rolw.

<img src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/80.png" />
...
3. Select **Clients**, and then click **supos**.
::info
The realm and client are preset, you can also add new ones as needed.
:::
