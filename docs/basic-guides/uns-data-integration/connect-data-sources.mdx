...
slug: /uns-data-integration/connect-data-sources
...
3. Click the flow you just added, enter the configuration canvas and drag in nodes according to your data source type (e.g.`modbus`).
...
:::tip
Click <img src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/203.png" /> to change the bound data flow.
:::
