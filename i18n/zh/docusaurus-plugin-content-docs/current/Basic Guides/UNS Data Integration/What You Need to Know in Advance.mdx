...
## User Journey
Follow the order displayed in the image, you will complete your first data flow in supOS.
...
- Data collected to and processed in supOS can be obtained by third parties through <a href="../../../openapi/#/">Open API</a> or MQTT subscription.
