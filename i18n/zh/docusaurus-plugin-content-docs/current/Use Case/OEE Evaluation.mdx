...
1. 登录平台，单击**数据管理**下的**数据建模**。
2. 单击 <img src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/5.png" /> 添加名为**Equipment**的文件夹。

<img width={450} src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/6-1.png" />

3. 单击 <img src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/7.png" /> 在**Equipment**下添加名为**CNC**的文件，并添加属性用于存储设备的实际运行时间和计划运行时间数据。

<img width={450} src="http://communityimage2.oss-cn-hangzhou.aliyuncs.com/8-1.png" />

4. 勾选**启用历史数据**，并单击**保存**。
5. 按相同操作添加关系型模型**Order/OrderInfo**、**Quality/OrderQualityLog**、**Quality/QualityAnalysis**。
