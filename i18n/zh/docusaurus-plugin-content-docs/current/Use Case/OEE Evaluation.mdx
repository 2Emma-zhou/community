...
### 添加数据源
数据模型构建完成后，**数据连接**中将生成含模拟数据的Node-RED数据流，需修改流的数据源以获取真实数据。
...
<ol>
<ol>
<li>将Excel文件保存至Node-RED所在的服务器。</li>
...
:::info
这些节点为自定义节点并已上传至Node-RED，详情请参考<a href="https://flows.nodered.org/node/factory-agent-states">factory-agent-states</a> 及 <a href="https://flows.nodered.org/node/factory-agent-deepseek">factory-agent-deepseek</a>.。
:::
